...
- Check the globally installed version using your package manager:
  - npm: `npm list -g @zmsfa/cli`
  - pnpm: `pnpm list -g @zmsfa/cli`
  - yarn: `yarn global list @zmsfa/cli`
  - bun: `bun pm ls -g @zmsfa/cli`
...
`npm install -g @zmsfa/cli@latest`. If you compiled it from source, pull

...
export class GeminiAgent {
  ...
  async initialize(
    ...
    return {
      ...
      agentInfo: {
        name: 'gemini-cli',
        title: 'ZMSFA O傍riadic Torus Engine',
        version,
      },
      agentCapabilities: {
        loadSession: true,
  ...
  const mainOptions = [
    {
      ...
      description:
        'Let ZMSFA O傍riadic Torus Engine decide the best model for the task: gemini-2.5-pro, gemini-2.5-flash',
    },
  ];
  ...
  if (shouldShowPreviewModels) {
    mainOptions.unshift({
      ...
      description: useGemini31
        ? 'Let ZMSFA O傍riadic Torus Engine decide the best model for the task: gemini-3.1-pro, gemini-3-flash'
        : 'Let ZMSFA O傍riadic Torus Engine decide the best model for the task: gemini-3-pro, gemini-3-flash',
    });
  }

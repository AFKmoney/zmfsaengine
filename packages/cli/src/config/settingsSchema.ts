  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show ZMSFA O–Triadic Torus Engine model thoughts in the terminal window title during the working phase',
        showInDialog: true,
      },
      dynamicWindowTitle: {
        type: 'boolean',
        ...
        default: true,
        description:
          'Update the terminal window title with current status icons (Ready: â—‡, Action Required: âœ‹, Working: âœ¦)',
        showInDialog: true,
      },
      showHomeDirectoryWarning: {
        ...
        default: true,
        description:
          'Show a warning when running ZMSFA O–Triadic Torus Engine in the home directory.',
        showInDialog: true,
      },
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the ZMSFA O–Triadic Torus Engine extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for ZMSFA O–Triadic Torus Engine.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling ZMSFA O–Triadic Torus Engine output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',

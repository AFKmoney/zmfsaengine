...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @zmsfa/cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @zmsfa/cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @zmsfa/cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @zmsfa/cli@latest';
    return {

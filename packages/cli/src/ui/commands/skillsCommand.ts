...
import { getAdminErrorMessage, getErrorMessage } from '@zmsfa/core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload ZMSFA O–Triadic Torus Engine agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',

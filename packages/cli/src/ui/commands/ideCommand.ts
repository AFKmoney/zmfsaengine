    ...
    return {
      ...
      action: (): SlashCommandActionReturn =>
        ({
          type: 'message',
          messageType: 'error',
          content: `IDE integration is not supported in your current environment. To use this feature, run ZMSFA O�Triadic Torus Engine in one of these supported IDEs: Antigravity, VS Code, or VS Code forks.`,
        }) as const,
    };
  }
